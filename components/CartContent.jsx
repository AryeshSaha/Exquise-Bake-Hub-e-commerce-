...
const CartContent = ({ setIsCartOpen, isCheckout }) => {
  const { cart, addToCart, reduceFromCart, clearCart, subTotalAmt } = useCart();
  return (
    <>
                    ...
                    <td className="px-2 py-3">
                      <div className="flex flex-col">
                        ...
                        <div className="text-md font-normal">
                          ({cart[item].flavor}/{cart[item].weight}{" "}
                          {cart[item].weight < 2 ? "pound" : "pounds"})
                        </div>
                      </div>
                    </td>
